...
After completing all offsets (if there is no offset available in game code, leave it as `00000000`) you can use regular expressions to delete everything unnecesary, f.e in Notepad++. 
